...
export function SkipJajanModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4 backdrop-blur-sm">
      <div className="relative w-full max-w-md overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900 shadow-2xl transition-all">
        {/* Header */}
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-zinc-900 border border-zinc-800 text-zinc-300 group-hover:text-lime-400 group-hover:border-lime-400/40 transition-colors">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="font-mono text-xs font-semibold text-lime-400 tabular-nums">
          ...
          <form onSubmit={handleCustomSubmit} className="mt-4 border-t border-zinc-800/80 pt-4">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 rounded-xl border border-zinc-800 bg-zinc-950 px-3 py-2 text-xs text-zinc-200 placeholder-zinc-600 focus:border-lime-400 focus:outline-none font-mono"
              />
              <input
                type="number"
                min="1000"
                ...
                className="w-28 rounded-xl border border-zinc-800 bg-zinc-950 px-3 py-2 text-xs text-zinc-200 placeholder-zinc-600 focus:border-lime-400 focus:outline-none font-mono tabular-nums"
              />
              <button
                type="submit"
                disabled={!customAmount}
                className="rounded-xl bg-lime-400 px-3 py-2 font-mono text-xs font-bold text-zinc-950 hover:bg-lime-300 disabled:opacity-40 transition-colors"
              >
                Setor
              </button>
            </div>
